...
namespace FluentValidationApp.Web.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create(Customer customer)
        {
            ...
            //ModelState.IsValid ile de validation kontrol edilebilirdir. web durumunda bu kullanılabilir.
            //CustomerValidator validationRules = new CustomerValidator(); ile de alınabilir. Fakat biz Dependecy Injection(DI) ile nesne örneği aldık
